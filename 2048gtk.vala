...
/**
 * 2048 Game - GTK4/Vala Implementation
 * Copyright (C) 2026 wszqkzqk <wszqkzqk@qq.com>
 * 
 * A classic 2048 sliding puzzle game implemented with GTK4 and Vala.
 * Use arrow keys or WASD to move tiles and combine them to reach 2048!
 */

public class Game2048 : Gtk.Application {
    ...
    construct {
        application_id = "io.github.wszqkzqk.Game2048";
    ...
    private void show_win_dialog () {
        var dialog = new Gtk.AlertDialog ("Congratulations! You reached 2048!") {
            detail = @"Your score: $(score)\nKeep playing to get an even higher score!",
    ...
    private void show_game_over_dialog () {
        var dialog = new Gtk.AlertDialog ("Game Over!") {
            detail = @"Your final score: $(score)\nTry again to beat your best score!",
